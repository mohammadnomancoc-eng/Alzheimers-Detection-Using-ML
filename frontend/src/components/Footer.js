...
const Footer = () => {
  const socialLinks = [
    ...
    {
      icon: <GithubIcon />,
      href: "https://github.com/mohammadnomancoc-eng/Alzheimers-Detection-Using-ML",
      label: "GitHub",
    },
    {
      icon: <Mail className="w-5 h-5" />,
      href: "mohammadnomancoc@gmail.com",
      label: "Email",
    },
  ];
  ...
  const navLinks = [
    ...
    { label: "Generate Analysis", href: "/#form" },
    { label: "Researcher Dashboard", href: "/dashboard" },
  ...
  return (
    <ModemAnimatedFooter
      ...
      navLinks={navLinks}
      creatorName="Mohammad Noman and Team"
